...
// Obtener estadísticas de oficios del usuario actual
$estadisticas = [
    'pendientes' => 0,
    'en_tramite' => 0,
    'atendidos' => 0,
...
// Obtener ID del usuario actual desde la base de datos usando el nombre de usuario
$usuario = $_SESSION['usuario'];
$query_usuario = "SELECT id FROM login WHERE usuario = '$usuario'";
...
// Consulta para contar oficios por estado del usuario actual
$query_estadisticas = "SELECT estado, COUNT(*) as total FROM oficios WHERE activo = 1 AND usuario_derivado_id = $usuario_id GROUP BY estado";
...
// Obtener actividad reciente del usuario actual (últimos 10 oficios derivados al usuario)
$actividad_reciente = [];
$query_actividad = "
...
<body>
    ...
    <script>
        function filterOficios(estado) {
            ...
            window.location.href = 'expedientesuser.php?estado=' + estado;
        }
